...
import uniffi.coverall_upstream_compatibility.*
...
Coveralls("test_complex_errors").use { coveralls ->
    ...
    try {
        ...
        assert(e.toString() == "uniffi.coverall_upstream_compatibility.ComplexException\$OsException: code=10, extendedCode=20") {
    ...
    try {
        ...
        assert(e.toString() == "uniffi.coverall_upstream_compatibility.ComplexException\$PermissionDenied: reason=Forbidden") {
    ...
    try {
        ...
        assert(e.toString() == "uniffi.coverall_upstream_compatibility.ComplexException\$UnknownException: ") {
